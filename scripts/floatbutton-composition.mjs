...
export function iconInstance(name){if(!manifest.iconRefs[name])throw new Error('Unknown Icon '+name);return {type:'script',scriptUri:'../canvas-components/Icon.js',name:'Icon',inputs:{name}};}
