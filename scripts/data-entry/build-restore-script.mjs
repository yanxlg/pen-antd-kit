...
for (const c of cardMap) {
  ...
  Update(row, { y: -15, width: 'fit_content', height: 30, padding: [0, 8, 4, 8], clip: false, layout: 'horizontal', alignItems: 'center' });
  Insert(row, {
    type: 'text',
    name: 'Example title',
    content: c.title,
  ...
  if (c.title === 'Basic') {
    ...
    Insert(preview, {
      ...
      width: 90,
      height: 32,
      inputs: { value: 3, min: 1, max: 10, size: 'middle' }
    });
  } else if (c.title === 'Sizes') {
    Update(preview, { layout: 'horizontal', padding: [24, 24], gap: 8, alignItems: 'center', height: 'fit_content' });
    Insert(preview, {
      type: 'ref',
      ref: masterId,
      ...
      width: 90,
      height: 40,
      inputs: { value: 3, min: 1, max: 100000, size: 'large' }
    });
    Insert(preview, {
      type: 'ref',
      ref: masterId,
      ...
      width: 90,
      height: 32,
      inputs: { value: 3, min: 1, max: 100000, size: 'middle' }
    });
    Insert(preview, {
      type: 'ref',
      ref: masterId,
      ...
      width: 90,
      height: 24,
      inputs: { value: 3, min: 1, max: 100000, size: 'small' }
    });
  } else if (c.title === 'Disabled') {
    Update(preview, { layout: 'vertical', padding: [24, 24], gap: 20, height: 'fit_content' });
    Insert(preview, {
      type: 'ref',
      ref: masterId,
      ...
      width: 90,
      height: 32,
      inputs: { value: 3, min: 1, max: 10, disabled: true, size: 'middle' }
    });
    Insert(preview, {
      type: 'ref',
      ref: buttonId,
    ...
    Insert(preview, {
      ...
      width: 200,
      height: 32,
      inputs: { value: '1.00000000000001', step: '0.00000000000001', min: 0, max: 10, stringMode: true, size: 'middle', controls: true }
    });
...
fs.writeFileSync('scripts/data-entry/restore-inputnumber-usage.pencil.js', script);
console.log('Generated scripts/data-entry/restore-inputnumber-usage.pencil.js');
