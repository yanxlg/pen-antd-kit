...
fs.writeFileSync('scripts/data-entry/apply-perfect-usage-fix.pencil.js', executionScript);
console.log('Saved script to scripts/data-entry/apply-perfect-usage-fix.pencil.js');
