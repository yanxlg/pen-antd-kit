...
// Horizontal Light
{
  const card = createCard(row1, 'Menu · Horizontal (Light)', 'Horizontal (Light)');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
{
  const card = createCard(row2, 'Menu · Horizontal with Submenu Popup', 'Horizontal with Submenu Popup');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
{
  const card = createCard(row3, 'Menu · Custom Submenu Render', 'Custom Submenu Render (popupRender)');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
{
  const card = createCard(row4, 'Menu · Vertical (Right arrow)', 'Vertical (Right arrow)');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
{
  const card = createCard(row4, 'Menu · Vertical with Submenu Popup', 'Vertical with Submenu Popup');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
{
  const card = createCard(row5, 'Menu · Collapsed', 'Collapsed (Light & Dark)');
