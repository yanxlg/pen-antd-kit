...
// Card 0: Canonical Menu (Master Component)
...
// Card 3: Horizontal with Submenu Popup
{
...
// Card 5: Inline (Default)
{
  const card = createCard(col1, 'Menu · Inline (Default)', 'Inline (Default)');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
// Card 7: Collapsed (Light & Dark)
{
  const card = createCard(col1, 'Menu · Collapsed', 'Collapsed (Light & Dark)');
...
// Card 12: Item States
{
  const card = createCard(col1, 'Menu · Item States', 'Item States (Default, Selected, Disabled, Danger)');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
{
  const card = createCard(col2, 'Menu · Horizontal (Dark)', 'Horizontal (Dark)');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
// Card 8: Vertical (Right arrow)
{
  const card = createCard(col2, 'Menu · Vertical (Right arrow)', 'Vertical (Right arrow)');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
// Card 9: Vertical with Submenu Popup
{
...
// Card 10: Sub-menu theme
{
  const card = createCard(col2, 'Menu · Sub-menu theme', 'Sub-menu theme (Dark root + Light submenu)');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
// Card 11: Dark Inline Theme
{
  const card = createCard(col2, 'Menu · Dark Inline Theme', 'Dark Inline Theme');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
// Card 13: Custom Semantic Styling
{
