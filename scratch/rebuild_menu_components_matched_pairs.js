...
function createCard(row, name, title) {
...
// ==========================================
// ROW 1 · Master & Vertical (Right arrow) (~210px height match)
// ==========================================
const row1 = createRow('Row 1 · Master & Vertical (Right arrow)');
...
{
  const card = createCard(row1, 'Menu · Vertical (Right arrow)', 'Vertical (Right arrow)');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
// ==========================================
// ROW 2 · Horizontal Light & Horizontal Dark (~94px height match)
// ==========================================
const row2 = createRow('Row 2 · Horizontal Light & Dark');

// Horizontal Light
{
  const card = createCard(row2, 'Menu · Horizontal (Light)', 'Horizontal (Light)');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
// Horizontal Dark
{
  const card = createCard(row2, 'Menu · Horizontal (Dark)', 'Horizontal (Dark)');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
// ==========================================
// ROW 3 · Horizontal Popup & Sub-menu theme (~270px height match)
// ==========================================
const row3 = createRow('Row 3 · Horizontal Popup & Sub-menu theme');

// Horizontal with Submenu Popup
{
  const card = createCard(row3, 'Menu · Horizontal with Submenu Popup', 'Horizontal with Submenu Popup');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
// Sub-menu theme (Dark root + Light submenu)
{
  const card = createCard(row3, 'Menu · Sub-menu theme', 'Sub-menu theme (Dark root + Light submenu)');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
// ==========================================
// ROW 4 · Custom PopupRender & Collapsed (~260-300px height match)
// ==========================================
const row4 = createRow('Row 4 · Custom Submenu & Collapsed');

// Custom Submenu Render (popupRender)
{
  const card = createCard(row4, 'Menu · Custom Submenu Render', 'Custom Submenu Render (popupRender)');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
{
  const card = createCard(row4, 'Menu · Collapsed', 'Collapsed (Light & Dark)');
...
// ==========================================
// ROW 5 · Vertical Popup & Item States (~180-200px height match)
// ==========================================
const row5 = createRow('Row 5 · Vertical Popup & Item States');

// Vertical with Submenu Popup
{
  const card = createCard(row5, 'Menu · Vertical with Submenu Popup', 'Vertical with Submenu Popup');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
// Item States
{
  const card = createCard(row5, 'Menu · Item States', 'Item States (Default, Selected, Disabled, Danger)');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
// ==========================================
// ROW 6 · Dark Inline Theme & Custom Semantic (~160-400px)
// ==========================================
const row6 = createRow('Row 6 · Dark Inline Theme & Semantic');

// Dark Inline Theme
{
  const card = createCard(row6, 'Menu · Dark Inline Theme', 'Dark Inline Theme');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
{
  const card = createCard(row6, 'Menu · Custom Semantic Styling', 'Custom Semantic Styling (Border & Soft Background)');
  const rowCards = Insert(card, {
    type: 'frame',
    name: 'Semantic row',
    layout: 'horizontal',
...
// ==========================================
// ROW 7 · Inline Default & Inline Multi-level (~460-540px height match)
// ==========================================
const row7 = createRow('Row 7 · Inline Navigation Trees');

// Inline (Default)
{
  const card = createCard(row7, 'Menu · Inline (Default)', 'Inline (Default)');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
...
// Inline (Multi-level)
{
  const card = createCard(row7, 'Menu · Inline (Multi-level)', 'Inline (Multi-level)');
  Insert(card, {
    type: 'ref',
    ref: canonicalMenu,
