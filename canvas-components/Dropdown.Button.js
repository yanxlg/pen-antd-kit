...
const iconNodes=[{type:'script',name:iconName,scriptUri:'../canvas-components/Icon.js',x:iconX-iconSize/2,y:iconY-iconSize/2,width:iconSize,height:iconSize,inputs:{name:iconName,fontSize:iconSize,color}}];
...
return [
 ...
 ...(loading?[{type:'script',name:'LoadingOutlined',scriptUri:'../canvas-components/Icon.js',x:loadingX,y:(H-iconSize)/2,width:iconSize,height:iconSize,inputs:{name:'LoadingOutlined',fontSize:iconSize,color}}]:[]),
