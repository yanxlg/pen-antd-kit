...
return [
 ...
 {type:'script',name:'Icon',scriptUri:'../canvas-components/Icon.js',x:(pencil.width-20)/2,y:28,width:20,height:20,inputs:{type:'PlusOutlined',name:'PlusOutlined',fontSize:20,color}},
