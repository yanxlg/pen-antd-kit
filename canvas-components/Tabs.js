 ...
 * @input type: enum("line", "card", "editable-card") = "line"
 * @input size: enum("small", "middle", "large") = "middle"
 * @input tabPlacement: enum("top", "bottom", "start", "end") = "top"
 * @input centered: boolean = false
 * @input hideAdd: boolean = false
 * @input tabBarGutter: number = 32
 * @input indicatorAlign: enum("start", "center", "end") = "center"
 * @input indicatorSize: number = 0
 * @input extraStart: string = ""
 * @input extraEnd: string = ""
 * @input extraStartWidth: number = 0
 * @input extraEndWidth: number = 0
 * @input extraStartMargin: number = 0
 * @input extraEndMargin: number = 0
