 ...
 * @input shape: enum("default", "circle", "round") = "default"
...
const h=i.size==='small'?24:i.size==='large'?40:32;nodes.push(box(0,0,i.shape==='circle'?h:W,h,'#0000000F',i.shape==='default'?4:h/2));
return nodes;
