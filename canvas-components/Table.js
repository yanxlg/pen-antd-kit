...
if(i.pagination&&i.pagination!=='false'){const pag=typeof i.pagination==='object'?i.pagination:parse(i.pagination,{}),pagProps=typeof pag==='object'&&pag!==null?pag:{};const pagSize=pagProps.size||(i.size==='small'?'small':'middle');nodes.push({type:'ref',ref:'Y9L6l',x:0,y:head+bodyHeight+16,width:W,height:pagSize==='small'?24:32,inputs:{align:'end',total:data.length,pageSize:10,current:1,size:pagSize,showSizeChanger:false,showQuickJumper:false,...pagProps}});}return nodes;
