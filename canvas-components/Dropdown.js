 ...
 * @input placement: enum("bottomLeft", "bottom", "bottomRight", "topLeft", "top", "topRight", "left", "leftTop", "leftBottom", "right", "rightTop", "rightBottom") = "bottomLeft"
 * @input arrow: boolean = false
 * @input arrowPointAtCenter: boolean = false
 * @input trigger: enum("hover", "click", "contextMenu") = "hover"
 * @input triggerType: enum("link", "button", "splitButton") = "link"
 * @input buttonType: enum("default", "primary", "dashed", "link", "text") = "default"
 * @input showTriggerIcon: boolean = false
 * @input splitIcon: enum("DownOutlined", "EllipsisOutlined", "UserOutlined", "LoadingOutlined") = "DownOutlined"
 * @input danger: boolean = false
 * @input loading: boolean = false
 * @input isButton: boolean = false
 * @input hideTrigger: boolean = false
 * @input size: enum("small", "middle", "large") = "middle"
 * @input triggerWidth: number = 120
 * @input triggerHeight: number = 32
 * @input popupWidth: number = 200
 * @input popupHeight: number = 104
...
function renderNavigation(component, i, W, H, metrics) {
  ...
  if(component==='Dropdown'){
    ...
    if(hideTrigger)triggerNode=null;
      ...
      const label=i.children||'Hover me',linkFontSize=i.size==='large'?16:14,linkIconSize=i.size==='small'?12:i.size==='large'?16:14,labelW=Math.ceil(measureExact(label,linkFontSize)),linkColor=i.disabled?disabled:primary;
      nodes.push(text('Dropdown link',label,0,(th-22)/2,labelW,22,linkColor,linkFontSize));
      nodes.push(icon('DownOutlined',labelW+8,(th-linkIconSize)/2,linkIconSize,linkColor));
    }
    if(triggerNode){
