/**
 * @schema 2.18
 * @input align: enum("start", "center", "end") = "start"
 ...
 * @input showLessItems: boolean = false
 * @input hideOnSinglePage: boolean = false
 * @input showTotal: enum("", "total", "range") = ""
 * @input previousLabel: string = ""
 * @input nextLabel: string = ""
 * @input customSizeChanger: string = ""
