 ...
 * @input size: enum("small", "middle") = "middle"
 * @input orientation: enum("horizontal", "vertical") = "horizontal"
 * @input titlePlacement: enum("horizontal", "vertical") = "horizontal"
 * @input type: enum("default", "navigation", "inline", "panel", "dot") = "default"
 * @input variant: enum("filled", "outlined") = "filled"
 * @input status: enum("wait", "process", "finish", "error") = "process"
