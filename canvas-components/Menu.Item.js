...
if (hasIcon) nodes.push({type:"script", name:"Icon", scriptUri:"../canvas-components/Icon.js", inputs:{type:i.icon,name:i.icon,fontSize:iconSize,color}, x:28, y:13, width:iconSize, height:iconSize});
