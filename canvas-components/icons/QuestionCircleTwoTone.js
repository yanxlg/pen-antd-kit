...
return definition.paths.map((attrs, index) => ({
  type: 'path',
  name: 'QuestionCircleTwoTone path ' + (index + 1),
  x,
  y,
  width: fontSize,
  height: fontSize,
