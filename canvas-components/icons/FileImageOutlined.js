...
return definition.paths.map((attrs, index) => ({
  type: 'path',
  name: 'FileImageOutlined path ' + (index + 1),
  x,
  y,
  width: fontSize,
  height: fontSize,
