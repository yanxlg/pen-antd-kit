...
return definition.paths.map((attrs, index) => ({
  type: 'path',
  name: 'ScanOutlined path ' + (index + 1),
  x,
  y,
  width: fontSize,
  height: fontSize,
