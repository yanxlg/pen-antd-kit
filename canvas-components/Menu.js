 ...
 * @schema 2.18
 * @input items: string = "[]"
 * @input mode: enum("vertical", "horizontal", "inline") = "vertical"
 ...
 * @input styles: string = "{}"
 * @input popupPlacement: enum("rightTop", "rightBottom") = "rightTop"
 * @input popupRender: boolean = false
