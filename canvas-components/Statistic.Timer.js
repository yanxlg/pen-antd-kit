...
nodes.push(text(i.title??'Countdown',0,0,W,22,14,'#00000073'));if(i.loading)nodes.push(box(0,30,160,24,'#F0F0F0',4));else nodes.push(text(i.value||'01:30:00',0,i.title?26:0,W,38,24));
return nodes;
