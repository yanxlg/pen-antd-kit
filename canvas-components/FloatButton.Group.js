 ...
 * @input href: string = ""
 * @input htmlType: enum("button", "reset", "submit") = "button"
 * @input open: boolean = false
 * @input placement: enum("left", "right", "bottom", "top") = "left"
...
const strokeCol = i.variant === "borderless" ? "#00000000" : borderCol;
  ...
  nodes.push(text(i.label || "FloatButton.Group", 12, Math.max(4, (H-18)/2), W - 24, disabled, 13));
return nodes;
