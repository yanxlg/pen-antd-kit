...
child(i.children,0,0,W,H);if(i.spinning===false)return nodes;if(i.children||i.fullscreen)nodes.push(box(0,0,W,H,i.fullscreen?'#00000073':'#FFFFFFA6'));const s=i.size==='small'?14:i.size==='large'?32:20,x=(W-s)/2,y=(H-s-(i.tip?28:0))/2,r=s*.28;if(i.indicator){child(i.indicator,x,y,s,s);}else [[0,0,.35],[s-r,0,.6],[s-r,s-r,1],[0,s-r,.8]].forEach(([dx,dy,o])=>nodes.push({type:'ellipse',name:'Spin dot',x:x+dx,y:y+dy,width:r,height:r,fill:'#1677FF',opacity:o}));if(i.tip)nodes.push(text(i.tip,0,y+s+8,W,22,14,'#1677FF','400','center'));
