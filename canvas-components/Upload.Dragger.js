...
return [
 ...
 {type:'script',name:'Icon',scriptUri:'../canvas-components/Icon.js',x:(W-48)/2,y:Math.max(20,H/2-54),width:48,height:48,inputs:{type:'InboxOutlined',name:'InboxOutlined',fontSize:48,color}},
