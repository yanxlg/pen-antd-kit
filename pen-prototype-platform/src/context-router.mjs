...
export function resolveContext({ input = "", prompt = "" }) {
  ...
  return {
    ...
    pattern: patternId,
    mustRead: [
      "references/library-preflight.md",
      `references/workflows/${workflow}.md`,
      `references/inputs/${kind}.md`,
      `references/patterns/${patternId}.md`,
      "references/quality/states.md",
      "references/quality/visual-review.md",
    ],
    optionalRead: ["references/quality/layout.md", "references/handoff.md"],
