...
test("routes Markdown management requirements progressively", () => {
  ...
  assert.ok(result.mustRead.includes("references/inputs/markdown.md"));
  assert.ok(result.mustRead.includes("references/patterns/list-page.md"));
  assert.ok(!result.mustRead.includes("references/patterns/dashboard.md"));
...
test("routes Pen input to revision", () => {
  ...
  assert.ok(result.mustRead.includes("references/workflows/revise.md"));
});
